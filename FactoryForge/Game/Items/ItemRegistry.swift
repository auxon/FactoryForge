...
final class ItemRegistry {
    ...
    func loadItems() {
        // Raw materials
        register(Item(id: "iron-ore", name: "Iron Ore", stackSize: 1000, category: .raw, order: "a"))
        register(Item(id: "copper-ore", name: "Copper Ore", stackSize: 1000, category: .raw, order: "b"))
        register(Item(id: "coal", name: "Coal", stackSize: 1000, category: .raw, order: "c", fuelValue: 4000, fuelCategory: "chemical"))
        ...
        register(Item(id: "lubricant", name: "Lubricant", stackSize: 0, category: .fluid, order: "j"))
        register(Item(id: "sulfuric-acid", name: "Sulfuric Acid", stackSize: 0, category: .fluid, order: "k"))
        register(Item(id: "uranium-ore", name: "Uranium Ore", stackSize: 1000, category: .raw, order: "l"))
        
        // Intermediate products
        register(Item(id: "iron-plate", name: "Iron Plate", stackSize: 1000, category: .intermediate, order: "a"))
        register(Item(id: "copper-plate", name: "Copper Plate", stackSize: 1000, category: .intermediate, order: "b"))
        register(Item(id: "steel-plate", name: "Steel Plate", stackSize: 1000, category: .intermediate, order: "c"))
        register(Item(id: "stone-brick", name: "Stone Brick", stackSize: 1000, category: .intermediate, order: "d"))
        register(Item(id: "iron-gear-wheel", name: "Iron Gear Wheel", stackSize: 1000, category: .intermediate, order: "e"))
        register(Item(id: "copper-cable", name: "Copper Cable", stackSize: 1000, category: .intermediate, order: "f"))
        register(Item(id: "pipe", name: "Pipe", stackSize: 1000, category: .intermediate, order: "f1"))
        register(Item(id: "electronic-circuit", name: "Electronic Circuit", stackSize: 1000, category: .intermediate, order: "g"))
        register(Item(id: "advanced-circuit", name: "Advanced Circuit", stackSize: 1000, category: .intermediate, order: "h"))
        register(Item(id: "processing-unit", name: "Processing Unit", stackSize: 500, category: .intermediate, order: "i"))
        register(Item(id: "engine-unit", name: "Engine Unit", stackSize: 500, category: .intermediate, order: "j"))
        register(Item(id: "electric-engine-unit", name: "Electric Engine Unit", stackSize: 500, category: .intermediate, order: "k"))
        register(Item(id: "plastic-bar", name: "Plastic Bar", stackSize: 1000, category: .intermediate, order: "l"))
        register(Item(id: "sulfur", name: "Sulfur", stackSize: 1000, category: .intermediate, order: "m"))
        register(Item(id: "battery", name: "Battery", stackSize: 1000, category: .intermediate, order: "n"))
        register(Item(id: "explosives", name: "Explosives", stackSize: 500, category: .intermediate, order: "o"))
        ...
        // Logistics items
        register(Item(id: "transport-belt", name: "Transport Belt", stackSize: 500, category: .logistics, order: "a", placedAs: "transport-belt"))
        register(Item(id: "fast-transport-belt", name: "Fast Transport Belt", stackSize: 500, category: .logistics, order: "b", placedAs: "fast-transport-belt"))
        register(Item(id: "express-transport-belt", name: "Express Transport Belt", stackSize: 500, category: .logistics, order: "c", placedAs: "express-transport-belt"))
        register(Item(id: "underground-belt", name: "Underground Belt", stackSize: 200, category: .logistics, order: "d", placedAs: "underground-belt"))
        ...
        register(Item(id: "inserter", name: "Inserter", stackSize: 200, category: .logistics, order: "d", placedAs: "inserter"))
        register(Item(id: "long-handed-inserter", name: "Long Handed Inserter", stackSize: 200, category: .logistics, order: "e", placedAs: "long-handed-inserter"))
        register(Item(id: "fast-inserter", name: "Fast Inserter", stackSize: 200, category: .logistics, order: "f", placedAs: "fast-inserter"))
        register(Item(id: "stack-inserter", name: "Stack Inserter", stackSize: 200, category: .logistics, order: "g", placedAs: "stack-inserter"))
        ...
        register(Item(id: "electric-mining-drill", name: "Electric Mining Drill", stackSize: 100, category: .production, order: "b", placedAs: "electric-mining-drill"))
        register(Item(id: "stone-furnace", name: "Stone Furnace", stackSize: 100, category: .production, order: "c", placedAs: "stone-furnace"))
        register(Item(id: "steel-furnace", name: "Steel Furnace", stackSize: 100, category: .production, order: "d", placedAs: "steel-furnace"))
        register(Item(id: "electric-furnace", name: "Electric Furnace", stackSize: 100, category: .production, order: "e", placedAs: "electric-furnace"))
        register(Item(id: "assembling-machine-1", name: "Assembling Machine 1", stackSize: 100, category: .production, order: "f", placedAs: "assembling-machine-1"))
        ...
        register(Item(id: "inserter", name: "Inserter", stackSize: 200, category: .production, order: "i", placedAs: "inserter"))
        register(Item(id: "fast-inserter", name: "Fast Inserter", stackSize: 200, category: .production, order: "j", placedAs: "fast-inserter"))
        register(Item(id: "long-handed-inserter", name: "Long Handed Inserter", stackSize: 200, category: .production, order: "k", placedAs: "long-handed-inserter"))
        ...
        register(Item(id: "steam-engine", name: "Steam Engine", stackSize: 50, category: .production, order: "k", placedAs: "steam-engine"))
        register(Item(id: "solar-panel", name: "Solar Panel", stackSize: 200, category: .production, order: "l", placedAs: "solar-panel"))
        register(Item(id: "accumulator", name: "Accumulator", stackSize: 100, category: .production, order: "m", placedAs: "accumulator"))
        register(Item(id: "small-electric-pole", name: "Small Electric Pole", stackSize: 200, category: .production, order: "n", placedAs: "small-electric-pole"))
        register(Item(id: "medium-electric-pole", name: "Medium Electric Pole", stackSize: 200, category: .production, order: "o", placedAs: "medium-electric-pole"))
        ...
        register(Item(id: "laser-turret", name: "Laser Turret", stackSize: 100, category: .combat, order: "d", placedAs: "laser-turret"))
